...
class IntroSlide extends Component {
  ...
  renderSlide() {
    ...
    if (this.props.slideNumber === '1') {
      const image = require('../../assets/images/slide1.png');
      Slide = (
        <View>
          {this.renderModal()}
          ...
          <View>
            ...
            <View style={styles.descriptionLogoStyle}>
              <Image
                source={require('../../assets/images/femaleSign.png')}
                style={{ height: win.width/8, width: win.width/8, resizeMode: 'cover' }}
              />
            </View>
      ...
      const image = require('../../assets/images/slide2.png');
      Slide = (
        <View>
          {this.renderModal()}
          {this.renderAlertModal()}
      ...
      const image = require('../../assets/images/slide3.png');
      Slide = (
        <View>
          {this.renderModal()}
          {this.renderAlertModal()}
          <View>
            ...
            <View style={styles.descriptionLogoStyle}>
              <Image
                source={require('../../assets/images/wineglass.png')}
                style={{ height:  win.width/8, width:  win.width/8 }}
              />
            </View>
            <View style={styles.descriptionTextViewStyle}>
