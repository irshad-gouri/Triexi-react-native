          ...
          >
            <ScrollView>
              <Text style={{ textAlign: "left", color: "#EF0043" }}>
                {`First of all, ES2015 (also known as ES6) is a set of improvements to JavaScript that is now part of te official standard, but not yet supported by all browsers, so often it isnt used yet in web development. React Native ships with ES2015 support, so you can use  this stuff without worrying about compatibility. import, from, class,   extends, and the () => syntax in the example above are all ES2015 features   . If you arent familiar with ES2015, you can probably pick it   up just by reading through sample code like this tutorial has.   If you want, this page has a good overview of ES2015 features. The other unusual thing in this code example is Hello   world!. This is JSX - a syntax for embedding XML within JavaScript. Many frameworks use a special templating language    which lets you embed code inside markup language. In React, this    is reversed. JSX lets you write your markup language inside code. It looks like HTML on the web, except instead of web things like  <div> or <span>, you use React components. In this case, is a built-in component that just displays some text.Ï`}
              </Text>
            </ScrollView>
          </View>
          <View
      ...
      <Modal isVisible={this.state.isAlertModalVisible}>
        <View style={styles.AlertModalViewStyle}>
          ...
          >
            ...
            >
              Please accept the Terms & Conditions if you agree and wish to
              continue.
            </Text>
          </View>
          <View
